<template>
	<view class="register_page">
		...
		<view class="input_box triangle" :class="[type == 1000 ? 'left_triangle': 'right_triangle']">
			<input type="number" maxlength="11" v-model="phone" @input="onInput" placeholder="请输入您的手机号" placeholder-class="grey" />
		</view>
		<view class="input_box" v-if="type == 2000">
			<input type="number" v-model="code" placeholder="请输入您的手机验证码" placeholder-class="grey" @input="onInput" maxlength="6" @confirm="onSubmit" />
